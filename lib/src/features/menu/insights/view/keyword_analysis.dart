...
import 'package:ads/src/res/keyword_analysis.dart';
import 'package:ads/src/res/search_analysis.dart';
              ...
              child: Column(
                children: [
                  ...
                  Table(
                    ...
                    children: KeywordAnalysisdetail.keyworddetails
                        .map(
                          (category) => buildRow(
                            [
                              if (listindex == 0)
                                category["keyword"].toString(),
                              if (listindex == 1) category["roas"].toString(),
