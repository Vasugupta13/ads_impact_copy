import 'package:ads/src/class/creatvie_analysis.dart';
...
class _CreativeAnalysisState extends State<CreativeAnalysis> {
  ...
  void updateTable() {
    filteredData = CreativeAnalysisDetails.creativedetails
        .map((category) => {
  ...
  Widget build(BuildContext context) {
    ...
    double total = CreativeAnalysisDetails.creativedetails.fold(
        0.0,
        (sum, category) =>
            sum +
            double.parse(
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              const CustomAppBar(
                  name: "Creative Analysis", imagepath: IconAssets.analysis),
              height5,
